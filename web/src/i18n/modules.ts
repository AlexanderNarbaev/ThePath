...
export const modules: ModuleMeta[] = [
  ...
  { number: 99, slug: 'scientific-foundations', title: { ru: 'Научные и философские основания', en: 'Scientific & Philosophical Foundations' }, subtitle: { ru: 'От термодинамики до Ubuntu — почему Спираль работает', en: 'From Thermodynamics to Ubuntu — Why the Spiral Works' }, audience: { ru: 'Изучающие, скептики, исследователи', en: 'Researchers, Skeptics, Scholars' }, path: 'deep' },
  { number: 98, slug: 'community-guide', title: { ru: 'Руководство по созданию общины', en: 'Community Startup Guide' }, subtitle: { ru: 'От первого собрания до устойчивой сети', en: 'From First Gathering to Sustainable Network' }, audience: { ru: 'Наставники, координаторы, все', en: 'Mentors, Coordinators, Everyone' }, path: 'mentor' },
];
